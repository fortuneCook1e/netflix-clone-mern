...
const MovieSlider = ({ category }) => {
  ...
  // useEffect to fetch data depends on the contentType and category
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        ref={sliderRef}
      >
        {/* we dont need content?.map because we've initialized the state with empty array. So content will never be null or undefined*/}
        {content.map((item) => (
          <Link
            to={`/watch/${item.id}`}
